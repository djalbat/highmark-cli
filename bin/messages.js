...
const FAILED_SERVER_MESSAGE = "Failed to serve.",
      ...
      WATCHING_CLIENT_FILE_MESSAGE = "Watching the client file.",
      WATCHING_OUTPUT_DIRECTORY_MESSAGE = "Watching the output directory.",
...
module.exports = {
  ...
  WATCHING_CLIENT_FILE_MESSAGE,
  WATCHING_OUTPUT_DIRECTORY_MESSAGE,
